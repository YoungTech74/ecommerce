...
<input type="submit" name="update" value="Update Records" class="btn btn-primary form-control">
...
$update_admin = "UPDATE admins SET admin_name = '$admin_name', admin_email = '$admin_email', admin_pass = '$admin_pass', admin_image = '$admin_image', admin_contact = '$admin_contact', admin_about = '$admin_about' WHERE admin_id = '$admin_id'";
