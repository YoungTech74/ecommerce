...
$age_range = $row_edit['age_range'];
$product_location = $row_edit['product_location'];
...
<br><img src="product_images/<?php echo $p_image3; ?>" width="70" height="70" >
    ...
    <div class="form-group" ><!-- form-group Starts -->
        ...
        <div class="col-md-6" >
          <input type="text" name="age_range" class="form-control" required value="<?php echo $age_range; ?>" >
      </div>
</div><!-- form-group Ends -->
    ...
    <div class="form-group" ><!-- form-group Starts -->
        ...
        <div class="col-md-6" >
          <input type="text" name="product_location" class="form-control" required value="<?php echo $product_location; ?>" >
      </div>
</div><!-- form-group Ends -->
...
</div><br><!-- description tab-pane fade in active Ends -->
...
$update_product = "UPDATE products SET p_cat_id='$product_cat',cat_id='$cat',manufacturer_id='$manufacturer_id', date=NOW(), product_title='$product_title', product_img1='$product_img1', product_img2='$product_img2', product_img3='$product_img3', product_price='$product_price', age_range='$age_range', product_location='$product_location', product_desc='$product_desc' WHERE product_id = '$p_id'";
