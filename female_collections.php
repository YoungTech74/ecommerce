...
<style>
  ...
  .search_btn {
    ...
    if(isset($_POST['search_btn'])){
      ...
      $get_female_products = "SELECT products.product_id, products.cat_id, categories.cat_id, categories.cat_title, products.product_title, products.product_img1, products.product_img2, products.product_img3, products.product_price, products.product_desc
      FROM products INNER JOIN categories ON products.cat_id = categories.cat_id WHERE categories.cat_title = 'Female' && products.product_title LIKE '%$search_name%' ORDER BY 1 DESC ";
