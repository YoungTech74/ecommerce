...
?>
  ...
  .search_btn {
    ...
    <!-- Main -->
    <div class="wrapper">
            <h1>Photographer Collections<h1>
    ...
    if(isset($_POST['search_btn'])){
      ...
      $get_products = "SELECT * FROM products WHERE product_title LIKE '%$search_name%' && service = 'Photographer'";
...
<?php
    ...
    ?>
    <!-- <h1 class="text-left float-left">Place Your Phone Call Right Now</h1> -->
